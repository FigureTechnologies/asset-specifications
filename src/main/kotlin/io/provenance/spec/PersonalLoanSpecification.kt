...
object PersonalLoanSpecification {

    val PersonalLoanScopeSpecification = ScopeSpecConfig(
    ...
    val PersonalLoanRecordSpecification = RecordSpecConfig(
        id = UUID.fromString("93c4af8a-fa32-4bd9-8207-005fd52bcbda"),
        name = "personalLoan",
        typeClassname = "io.provenance.model.v1.Asset",
    )

    val PersonalLoanContractSpecification = ContractSpecConfig(
    ...
    fun specificationTx(owner: String) = SpecWriter.buildMetadataSpecificationTransaction(
        owner = owner,
        scopeSpec = PersonalLoanScopeSpecification,
        recordSpecList = listOf(PersonalLoanRecordSpecification),
        contractSpecList = listOf(PersonalLoanContractSpecification)
    )
}